...
@implementation DTVFormField

+ (DTVFormField *)initWithFieldDefinition:(NSDictionary*)dict;
{
    ...
    DTVFormField *field = [[DTVFormField alloc] init];
...
- (DTVConfigDrivenTableViewCell *)tableViewCell;
{
    ...
    // instantiate it
    DTVConfigDrivenTableViewCell *cell = [[CellClass alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier model:[self model] fieldDefinition:self];
